...
features_incorporated = '[{"name":"czech-iso-citation","base":"v0.1.3"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-0.1.3"

configuration = '{"name": "citeproc-py-styles", "oarepo": 13, "features": [{"name": "czech-iso-citation", "base": "v0.1.3"}], "package": "citeproc-py-styles", "invenio_version": "0.1.3", "version": "0.1.3"}'
